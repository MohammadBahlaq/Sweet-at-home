...
class _FilteringState extends State<Filtering> {
  ...
  //Bedrooms colors
  List<Color> colorBedRooms = [Colors.brown, Colors.grey, Colors.grey, Colors.grey, Colors.grey];

  //Bathrooms colors
  List<Color> colorBathRooms = [Colors.brown, Colors.grey, Colors.grey, Colors.grey];

  //Kitchen colors
  List<Color> colorKitchens = [Colors.brown, Colors.grey, Colors.grey, Colors.grey];

  //LivingRoom colors
  List<Color> colorLivingRooms = [Colors.brown, Colors.grey, Colors.grey, Colors.grey, Colors.grey];
  ...
  void initValue(String btnName) {
    switch (btnName) {
      case "BedRooms":
        if (Data.nBedRooms[0] == 1 && Data.nBedRooms[1] == 2 && Data.nBedRooms[2] == 3 && Data.nBedRooms[3] == 4) {
        ...
        break;
      case "BathRooms":
        if (Data.nBathRooms[0] == 1 && Data.nBathRooms[1] == 2 && Data.nBathRooms[2] == 3) {
        ...
        break;
      case "Kitchens":
        if (Data.nKitchens[0] == 1 && Data.nKitchens[1] == 2 && Data.nKitchens[2] == 3) {
        ...
        break;
      case "LivingRooms":
        if (Data.nLivingRooms[0] == 1 && Data.nLivingRooms[1] == 2 && Data.nLivingRooms[2] == 3 && Data.nLivingRooms[3] == 4) {
  ...
  ElevatedButton ElevatedButtonCreat(String name, int index, String type) {
    switch (type) {
      case "BedRooms":
        return ElevatedButton(
          style: ElevatedButton.styleFrom(
            backgroundColor: colorBedRooms[index], //index
      ...
      case "BathRooms":
        return ElevatedButton(
          style: ElevatedButton.styleFrom(
            backgroundColor: colorBathRooms[index], //index
            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
          ),
          child: Text(name), //name
          onPressed: () {
      ...
      case "Kitchens":
        return ElevatedButton(
          style: ElevatedButton.styleFrom(
            backgroundColor: colorKitchens[index], //index
            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
          ),
          child: Text(name), //name
          onPressed: () {
      ...
      case "LivingRooms":
        return ElevatedButton(
          style: ElevatedButton.styleFrom(
            backgroundColor: colorLivingRooms[index], //index
            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
          ),
          child: Text(name), //name
          onPressed: () {
  ...
  ElevatedButton btnSaleRentCreate(int index1, index2, String type1, type2) {
    ...
    return ElevatedButton(
      style: ElevatedButton.styleFrom(
        backgroundColor: colorSaleRent[index1],
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
      ),
      onPressed: () {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          const Text("Select Governorate", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
          DropdownButton(
            isExpanded: true,
            value: Data.selected,
            items: [
          ...
          ElevatedButton(
            ...
            onPressed: () {
              setState(() {
                if (formstate2.currentState!.validate() && formstate.currentState!.validate()) {
